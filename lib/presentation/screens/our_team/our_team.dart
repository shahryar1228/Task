...
class _OurTeamState extends State<OurTeam> {
  ...
  void initState() {
    super.initState();
    Get.find<OurTeamController>().loadDepartmentsData();
  }
    ...
    return Padding(
      ...
      child: Column(
        children: [
          Container(
            ...
            child: Row(
              ...
              children: [
                ...
                Text(translate("our_team.add_new_person"),
          ...
          Expanded(
            child: GetBuilder<OurTeamController>(
...
class OurTeamControllerBind extends Bindings {
  @override
  void dependencies() {
